...
fs.writeFileSync(
  ...
  [
    ...
    "1. Run ./install.sh",
    "2. Verify with:",
    "   ~/Library/Application Support/CodexSessionsViewerBridge/bin/codex-sessions-viewer-doctor",
    "3. Open the hosted viewer with:",
    "   ~/Library/Application Support/CodexSessionsViewerBridge/bin/codex-sessions-viewer-open",
